...
<script type="text/javascript" src="<?php echo base_url();?>assets/scripts/jquery-ui-1.10.4.min.js"></script>
        ...
        <div class="top-tools-inner">
            <div class="btn-group user-btn">
                <a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
                    <span>Hello <?php echo $Fname; ?>!</span> 
                    <span class="label label-info"><?php echo $followers.' Follower'.($followers == 1 ? '':'s');?></span>
