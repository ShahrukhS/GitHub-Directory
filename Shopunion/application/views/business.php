...
<head>
        ...
        <link rel="stylesheet" href="../Content/jquery-ui-1.8.18.custom.css"/>
        ...
        <script src="../Scripts/account.js?v=44NsTjZAz7HnitT_Pcq4b3r7zj1c6yqa4ix6q6UhfPA1"></script>
	...
	<body cz-shortcut-listen="true">
		<div id="header">
			<div class="header-inner">
				<a href="#" id="logo">
					<img src="../Content/images/logo.png" width="223" alt="" />
				</a>    
			</div>
		</div>
			...
			<div class="top-tools-inner">
				<div class="btn-group user-btn">
					<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
						<span>Hello Zohair!</span> 
						<span class="label label-info">0 Followers</span>
			...
			<div id="content">
				...
				<div class="left-nav">
					<ul class="nav-ul">
						...
						<li><a href="/Business/ChangePassword">Password</a></li>                                        
					</ul>
        ...
        <div class="completness">
            ...
            <div class="completness-digits">
                <img src="../Content/images/Progress3.png"  />
            </div>
					...
					<div class="account-personal">
						...
						<div id="account-personal-info-block">
							...
							<div class="account-photo">
								<img src="../Content/images/upload-photo-blank.gif" />
						...
						<div id="account-business-info-block">
							<table id="account-info-table">
								<tbody>
									<tr>
										<td>Business name:</td>
										<td class="value"><?php echo $business_name;?></td>
									</tr>
									<tr>
										<td>Feed:</td>
									...
									<tr>
										<td>Website:</td>
										<td class="value"><?php echo $website;?></td>
									</tr>
									<tr>
										<td>Frequency:</td>
										<td class="value">Several per week</td>
									</tr>
									<tr>
										<td>Type:</td>
										<td class="value"><?php echo $type;?></td>
									</tr>
									<tr>
										<td>Description:</td>
...
<form action="/Business/EditPersonal" id="editPersonalForm" method="post">						<p>
							...
							<input class="text" data-val="true" data-val-required="The First name: field is required." id="BusinessEditModel_FirstName" name="BusinessEditModel.FirstName" type="text" value="Zohair" />
							<label id="firstNameError" class="formError">This field is required</label>
						</p>
					    <p>
					        <label for="last-name-box">Last name:</label>
					        <input class="text" data-val="true" data-val-required="The Last name: field is required." id="BusinessEditModel_LastName" name="BusinessEditModel.LastName" type="text" value="Hemani" />
					        <label id="lastNameError" class="formError">This field is required</label>
					    </p>
                        <p>
							<label for="email-box">Email:</label>
							<input class="text" data-val="true" data-val-required="The Email: field is required." id="BusinessEditModel_Email" name="BusinessEditModel.Email" type="text" value="zohairhemani1@gmail.com" />
...
<form action="/Business/EditBusiness" id="editBusinessForm" method="post">						<table>
							<tr>
								...
								<td>
									<input class="text" data-val="true" data-val-required="The Business Name field is required." id="BusinessEditModel_BusinessName" name="BusinessEditModel.BusinessName" type="text" value="Avialdo Solutions (Pvt)" />
							...
							<tr>
								...
								<td><input class="text" id="BusinessEditModel_Site" name="BusinessEditModel.Site" type="text" value="www.avialdo.com" /></td>
							</tr>
							<tr>
								<td class="title">Description:</td>
								<td>
									<textarea class="text" cols="20" data-val="true" data-val-required="The Description field is required." id="BusinessEditModel_Description" name="BusinessEditModel.Description" rows="2">
Avialdo Solutions (Pvt) Is a software house located in Karachi, Pakistan.</textarea>
							...
							<tr>
								...
								<td>
									<div class="btn-group">
										<a class="btn dropdown-toggle" data-toggle="dropdown" href="#"><div style="float:left"><label id="selectedCategory" style="margin-bottom:0"> Technology </label></div><div class="arrows"></div></a>
										...
										<ul id="categoryDDL" class="dropdown-menu">
												<li>Arts/Crafts <input type="hidden" value="6c432470-2c72-43ea-ac66-ef63c16402b9" /></li>    
												<li>Associations <input type="hidden" value="d9d541e5-ae59-4ef9-bcea-9d32c010e41b" /></li>    
												<li>Automotive <input type="hidden" value="2963c03e-2c46-461b-8b36-a46a476524fc" /></li>    
												<li>Banks <input type="hidden" value="31516cbb-560e-4355-8d5c-ef9bedf6d182" /></li>    
												<li>Bars <input type="hidden" value="db74ac10-78c3-4dba-b035-35b1af6e1ec9" /></li>    
												<li>Charitable Organizations <input type="hidden" value="ff877326-3a28-4601-9025-58d2f05e2172" /></li>    
												<li>Clubs <input type="hidden" value="9037df20-4e92-4928-9263-b727b31243a3" /></li>    
												<li>Entertainment/Bands <input type="hidden" value="ca8a34c2-27ea-4d20-b2ae-7b4235e5bd54" /></li>    
												<li>Events/Festivals <input type="hidden" value="7eea044a-f0e6-474c-99bd-aa70ba0ca592" /></li>    
												<li>Fitness <input type="hidden" value="cc10cf17-d6cb-40f1-b91a-b0014efd78bf" /></li>    
												<li>Food Trucks <input type="hidden" value="1437b8cf-4e49-4943-9ae6-cf0be867c22b" /></li>    
												<li>Funeral Homes/Monuments <input type="hidden" value="f6f28e8e-42eb-46ab-8943-97fbf109704c" /></li>    
												<li>Government <input type="hidden" value="48e4deaa-cdd4-41f3-86ce-b8e0f789d867" /></li>    
												<li>Health/Beauty/Wellness <input type="hidden" value="605b6d41-c8b3-4187-b7e0-28859512a11e" /></li>    
												<li>Historic/Tourism <input type="hidden" value="8fe8faa4-500c-4eba-889f-1756aa99a8ef" /></li>    
												<li>Home Services <input type="hidden" value="0f19eb4d-b8c7-4bd3-a09a-5e116048c2c8" /></li>    
												<li>Hotels/B&amp;Bs <input type="hidden" value="806be520-28ee-41ad-aa3a-300eeb52cab8" /></li>    
												<li>Legal <input type="hidden" value="1e2df6e3-9643-4a73-b531-c87e994c4fb8" /></li>    
												<li>Medical/Dental <input type="hidden" value="3cbd42e7-ebe9-4411-932a-526fde77a65b" /></li>    
												<li>Miscellaneous <input type="hidden" value="62cb1246-b0ac-40ef-919c-eaa8a519aecb" /></li>    
												<li>News/Publications <input type="hidden" value="20550275-c951-4f98-acd2-8cbf85e89bd9" /></li>    
												<li>Pet Care <input type="hidden" value="4bcc4347-45c1-44b7-95fc-ffddd43e6f2d" /></li>    
												<li>Politics <input type="hidden" value="aa8afb08-b509-4103-9cd1-96e5d619cefe" /></li>    
												<li>Professional <input type="hidden" value="d943aada-833d-4507-9383-a6fd5d01039e" /></li>    
												<li>Real Estate <input type="hidden" value="02de73ad-428a-4f60-ba4e-37a9e598e928" /></li>    
												<li>Religious <input type="hidden" value="69a2d8a8-f9ba-4286-ae0b-a46ee9a5d22a" /></li>    
												<li>Restaurants <input type="hidden" value="0d943ecf-34ef-4ccc-be86-31552dc484de" /></li>    
												<li>Retail <input type="hidden" value="64c338ae-f3f9-4cfd-ba71-c867e73fd8b4" /></li>    
												<li>Schools <input type="hidden" value="68712b02-a2a6-4ecc-a89d-1ca6b23fb91e" /></li>    
												<li>Sports/Teams <input type="hidden" value="09a48cf3-4c29-406c-bece-8a54da5c92cc" /></li>    
												<li>Technology <input type="hidden" value="0db27434-b034-4a3d-8ef4-79cdedc3e2fe" /></li>    
												<li>TV/Radio <input type="hidden" value="6be09b28-e1f5-4163-be04-2dc516bed664" /></li>    
										</ul>
							...
							<tr>
								...
								<td>
									<div class="btn-group">
										<a class="btn dropdown-toggle" data-toggle="dropdown" href="#"><div style="float:left"> <label id="selectedFrequency" style="margin-bottom:0"> Several per week </label></div><div class="arrows"></div></a>
										...
										<ul id="frequencyDDL" class="dropdown-menu">
												<li>1 or more a day <input type="hidden" value="120e9402-695e-4841-a085-5334d60352d5" /></li>    
												<li>As events happen <input type="hidden" value="05b10e73-c79d-4361-8f18-bcbd99ab1517" /></li>    
												<li>Several per month <input type="hidden" value="e43f5eef-b57d-4082-bccd-e13c3d1ce548" /></li>    
												<li>Several per week <input type="hidden" value="1aab2603-333a-4874-9eb1-5fa1d3010ddf" /></li>    
										</ul>
										<script type="text/javascript">
											(function () {
...
>
		...
		<div id="change-profile-picture" class="modal hide">
			...
			<div class="modal-body">
<form action="/Business/UploadPic" enctype="multipart/form-data" id="uploadPicForm" method="post">						<img id="profile-picture-blank" src="../Content/images/upload-photo-blank.gif" />
		...
		<script type="text/javascript">
			...
			var openBasicUpgrade = function () {
				...
				StripeCheckout.open({
					...
					panelLabel: 'Upgrade',
					image: '../Content/images/upload-photo-blank.gif',
					token: token,
